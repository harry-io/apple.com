      ...
      <div className="actualform">
        ...
        <form className="data">
          ...
          <div className="addressinfo">
            ...
            <input type="text" placeholder="Address Line1" required value={address1} onChange={(e)=>setAddress1(e.target.value)}/>
            <input type="text" placeholder="Address Line2" required value={address2} onChange={(e)=>setAddress2(e.target.value)}/>
            <input type="text" placeholder="PIN code" required value={pincode} onChange={(e)=>setPincode(e.target.value)}/>
            <input type="text" placeholder="State" required value={statename} onChange={(e)=>setStatename(e.target.value)}/>
          ...
          <div>
            ...
            <div className="contactinfo">
              ...
              <input type="phone" placeholder="Indian Mobile Number" required value={phone} onChange={(e)=>setPhone(e.target.value)}/>
            </div>
          </div>
