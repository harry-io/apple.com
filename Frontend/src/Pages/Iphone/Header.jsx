...
const Header = () => {
  return (
    <HeaderMain>
      <HeaderMainA>
        <ParaA>Shop iPhone</ParaA>
      </HeaderMainA>
      <HeaderMainB>
        <HeaderMainBa>
          <Image
            src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/store-chat-specialist-icon-202211_AV1?wid=35&hei=35&fmt=jpeg&qlt=95&.v=1671246164100"
            alt="help"
          />
          <Div>
