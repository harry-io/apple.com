...
export const getOrdersData = (dispatch) => {
  ...
  axios
    .get(`https://back-ened-bolt.onrender.com/cartProducts/`, {
      headers: {
...
export const getProductsCount = (dispatch) => {
  dispatch({ type: types.LOADING });
  axios
    .get(`https://back-ened-bolt.onrender.com/products/`, {
      headers: {
        Authorization: `bearer ${getData("token_bolt")}`,
      },
    })
...
export const DeleteOrdersData = (id) => (dispatch) => {
  dispatch({ type: types.LOADING });
  axios
    .delete(`https://back-ened-bolt.onrender.com/cartProducts/${id}`, {
      headers: {
        Authorization: `bearer ${getData("token_bolt")}`,
      },
    })
...
export const getAdminProducts = (dispatch) => {
  dispatch({ type: types.LOADING });
  axios
    .get(`https://back-ened-bolt.onrender.com/adminProducts/`, {
      headers: {
        Authorization: `bearer ${getData("token_bolt")}`,
      },
    })
...
export const AddAdminProducts = (details) => async (dispatch) => {
  dispatch({ type: types.LOADING });
  axios
    .post(`https://back-ened-bolt.onrender.com/adminProducts/add`, details, {
      headers: {
        Authorization: `bearer ${getData("token_bolt")}`,
      },
    })
...
export const DeleteAdminProducts = (id) => async (dispatch) => {
  dispatch({ type: types.LOADING });
  axios
    .delete(`https://back-ened-bolt.onrender.com/adminProducts/${id}`, {
      headers: {
        Authorization: `bearer ${getData("token_bolt")}`,
      },
    })
...
export const editAdminProducts = (id, changes) => async (dispatch) => {
  dispatch({ type: types.LOADING });
  axios
    .patch(`https://back-ened-bolt.onrender.com/adminProducts/${id}`, changes, {
      headers: {
        Authorization: `bearer ${getData("token_bolt")}`,
      },
    })
...
export const editAdminDetails = (id, changes) => async (dispatch) => {
  ...
  axios
    .patch(
      `https://back-ened-bolt.onrender.com/users/adminUpdate/${id}`,
      changes,
      {
        headers: {
          Authorization: `bearer ${getData("token_bolt")}`,
